...
- Every release publishes **checksums, an SBOM per artifact (generated by Synapse's own engine, dogfooding),
  a deterministic release-evidence manifest, and a provenance attestation**. See
